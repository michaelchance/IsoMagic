(function(){
	...
	if(isNode){
		...
		window.pathToRegexp.parse = parse
		window.pathToRegexp.compile = compile
		window.pathToRegexp.tokensToFunction = tokensToFunction
		window.pathToRegexp.tokensToRegExp = tokensToRegExp
		}
